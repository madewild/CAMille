...
list_objects=$(aws s3 ls s3://camille-data/PDF/B14138/1954/ | awk '{print $4}')
...
for old_object_name in $list_objects; do
    ...
    aws s3 mv s3://camille-data/PDF/B14138/1954/$old_object_name s3://camille-data/PDF/B14138/1954/$new_object_name
done